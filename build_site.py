...
REPORTS = [
    ...
    {"dst":"umdk","entry":"index.html","visual":"UMDK",
     "title":"UMDK Survey by AI",
     "desc":"3 份分析报告 — CAM 通信加速库 v2 (8章) + URPC 架构深潜 (11篇) + CAM v1 · EP Normal Zero-Buffer / Low-Latency 8+4 / Fused Deep MoE / Catlass GEMM / URPC 全栈 / UBPlus 增强协议",
     "cat":"chip","priority":"p0",
     "tags":["UMDK","CAM","URPC","EP通信","Low-Latency","Fused Deep MoE","Catlass","UBPlus","全栈","MoE专家并行"]},
