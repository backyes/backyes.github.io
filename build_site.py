...
REPORTS = [
    ...
    {"dst":"umdk","entry":"analysis/cam_v2/CAM深度分析报告_v2.html","visual":"UMDK/CAM\n通信加速库",
    ...
    {"dst":"pd-separation","entry":"report.html","visual":"P/D 分离\nKVCache\n流通",
    ...
    {"dst":"mlsys2026","entry":"index.html","visual":"MLSys 2026\n19 篇论文\n深度综合",
    ...
    {"dst":"deepseek-mtp","entry":"index.html","visual":"MTP 算法\n算力影响\n分析",
    ...
    {"dst":"moe-clos","entry":"report.html","visual":"Sparse CLOS\nMoE 推理\n效率分析",
    ...
    {"dst":"generative-rec","entry":"generative_recommendation_report.html","visual":"生成式\n推荐系统\n研究热点",
     "title":"生成式推荐研究热点",
     "desc":"2026 年 Generative Recommendation 最新研究热点调查报告 · 算法 + 系统 + 工业落地",
     "cat":"recsys","priority":"p1",
     "tags":["推荐系统","生成式推荐","RecSys","工业落地","算法"]},
    {"dst":"sparse-clos","entry":"sparse_clos_report.html","visual":"Sparse CLOS\nMoE 推理\n效率分析",
    ...
    {"dst":"space-ecom","entry":"report.html","visual":"太空经济\n产业调研\n306 家",
     "title":"太空经济联盟调研",
     "desc":"联盟首批意向成员 + 初创企业调研报告 · 含 306 家深度分析",
     "cat":"space","priority":"p2",
     "tags":["太空经济","航天","初创企业","产业调研"]},
    {"dst":"pd-routing","entry":"report.html","visual":"PD 分离\nRequest\nRouting",
    ...
    {"dst":"hbm-cxl","entry":"report.html","visual":"HBM/CXL\nMemory\n市场调研",
    ...
    {"dst":"inference-community","entry":"web/sources/coreweave_inference.html","visual":"推理社区\n2026\n前沿动态",
    ...
    {"dst":"deepepv2","entry":"html/index.html","visual":"DeepGEMM\n& DeepEP\n三向对比",
...
def gen_hero():
    return _join([
        ...
        '    <ul class="aside-list">',
        '      <li><span>Latest post</span><a href="posts/when-do-we-need-global-address-service.html">When Do We Need a Global Address Service</a> — amortizing communication pipe costs from Redis to NVLink.</li>',
        ...
        '      <li><span>Browse all</span><a href="posts.html">12 posts</a> on GPU, memory, CXL, Kimi3, and infrastructure economics · <a href="#survey">21 AI survey reports</a> with paper-level depth.</li>',
        '    </ul>',
        '  </aside>',
        '</section>',
    ])
