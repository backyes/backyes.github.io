...
REPORTS = [
    ...
    {"dst":"hbm-cxl","entry":"report.html","visual":"HBM",
     ...
     "desc":"HBM4 三强竞赛 / CXL 3.0 商用 / DRAM 结构性变化 · SK海力士 Samsung Micron 全景对比 · 2026.7",
     "cat":"storage","priority":"p1","published_at":"2026-08-13",
     "tags":["HBM","CXL","存储","内存层级","三星","SK海力士","美光"]},
    {"dst":"inference-community","entry":"report.html","visual":"InferCom",
     "title":"vLLM vs SGLang 推理引擎社区调研",
     "desc":"vLLM vs SGLang 全景对比 · Benchmark / 架构演进 / PD Disagg / KV Cache 设计哲学 · 2025.7~2026.7",
     "cat":"inference","priority":"p1","published_at":"2026-08-13",
     "tags":["vLLM","SGLang","推理引擎","KV Cache","PD分离","RadixAttention","基准测试"]},
...
document.addEventListener('DOMContentLoaded', function(){{
  if(typeof renderMathInElement==='function')
    renderMathInElement(document.querySelector('.article-body'),{{delimiters:[{{left:'$$',right:'$$',display:true}},{{left:'$',right:'$',display:false}}],throwOnError:false}});
}});
</script>
<script>
