...
<style>
.article-body h2{{font-size:1.75rem;font-weight:700;margin:2.5em 0 .8em;padding-bottom:.5em;border-bottom:2px solid var(--accent);color:var(--fg);letter-spacing:-.01em}}
.article-body h3{{font-size:1.35rem;font-weight:600;margin:2em 0 .6em;padding-left:12px;border-left:3px solid var(--accent);color:var(--fg2)}}
...
.article-body blockquote{{border-left:4px solid var(--accent);background:var(--callout);padding:12px 18px;margin:1.5em 0;border-radius:0 8px 8px 0}}
</style>
...
.article-body hr{{border:none;border-top:1px solid var(--border-soft);margin:2.5em 0}}
.article-body table{{border-collapse:collapse;width:100%;margin:1.5em 0;font-size:.9em}}
.article-body th{{background:var(--surface);font-weight:600;font-size:.82rem;text-transform:uppercase;letter-spacing:.03em;padding:10px 12px;border:1px solid var(--border);text-align:left}}
.article-body td{{padding:8px 12px;border:1px solid var(--border);vertical-align:top}}
.article-body tr:nth-child(even) td{{background:rgba(24,27,32,.3)}}
