...
REPORTS = [
    ...
    {"dst":"vllm_research/vllm_analysis","entry":"index.html","visual":"vLLM",
     "title":"vLLM 架构统一分析",
     "desc":"12 章统一分析 + 3 专题 (第一性原理 / 热路径 / KV-Cache 4 层 / 分布式 / Ascend Overlay / Perf Handbook) · 百万序列 Prefill 专题 (Chunked/CP/MLA/KV Offload/Disagg/Sparse 6 路线) · HBM 索引架构 · vllm_ascend 全模块 · 每节 source 溯源锚点",
     "cat":"inference","priority":"p0",
     "tags":["vLLM","KV-Cache","调度器","分布式推理","Ascend","百万Prefill","HBM索引","性能调优"]},
