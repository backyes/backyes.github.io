...
Build NIXL binaries and install them
Build and install the CUDA platform-specific package (nixl-cu12 or nixl-cu13)
Build and install the nixl meta-package
