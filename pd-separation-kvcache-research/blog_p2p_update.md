...
Round-Robin: mapping src_rank 0 -> tgt_rank 0, … mapping src_rank 7 -> tgt_rank 7
All existing sources have the same load. Another round of round-robin to assign src_rank 0 -> tgt_rank 8, … src_rank 7 -> tgt_rank 15
Finally, note tgt_rank 16 is identical compared to tgt_rank 0. Look back at existing assignments, and add identical engine rank to its existing source. We end up with src_rank 0 -> [tgt_rank [0, 16], tgt_rank [8, 24]], etc.
Identify SGLang Tensors to Transfer
