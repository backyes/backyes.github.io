...
- Upstream vLLM design doc for generic graph concepts: CUDA Graphs.
- PyTorch graph documentation for generic capture and replay semantics: Accelerating PyTorch with CUDA Graphs.
- Ascend user guide for operational enablement: Graph Mode Guide.
